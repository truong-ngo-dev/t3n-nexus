package vn.t3nexus.customer.infrastructure.crosscutting.config;
...
// (vn.t3nexus.lib.web.commons.exception vs vn.t3nexus.customer) — không @Import tường minh thì mọi
