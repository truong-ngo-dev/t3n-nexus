...
public enum UserErrorCode implements ErrorCode {
    ...
    EMAIL_ALREADY_EXISTS      ("10001", "Email already exists",                      "error.user.email_exists",              409),
    ...
    INVALID_PASSWORD          ("10007", "Invalid rawPassword",                       "error.user.invalid_password",          401),
    INVALID_CURRENT_PASSWORD  ("10008", "Current rawPassword is incorrect",          "error.user.invalid_current_password",  401),
    CURRENT_PASSWORD_REQUIRED ("10009", "Current rawPassword is required",           "error.user.current_password_required", 422),
