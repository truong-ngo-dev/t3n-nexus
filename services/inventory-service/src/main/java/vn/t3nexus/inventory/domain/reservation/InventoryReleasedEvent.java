...
public class InventoryReleasedEvent extends AbstractDomainEvent {
    ...
    public InventoryReleasedEvent(String reservationId, String orderId, List<ReservationItem> items) {
    ...
    @Override
    public String getRoutingKey() { return "inventory.reservation.released"; }
