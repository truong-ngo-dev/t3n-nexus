...
public class BlockProductStocks {
    ...
    public void handle(Command command) {
        ...
        if (stocks.isEmpty()) {
            log.info("[BlockProductStocks] no stocks found for productId={}", command.productId());
            return;
        }
        ...
        log.info("[BlockProductStocks] blocked {} stocks for productId={}, traceId={}",
