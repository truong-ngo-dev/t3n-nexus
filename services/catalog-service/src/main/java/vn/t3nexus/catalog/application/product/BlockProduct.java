...
public class BlockProduct implements CommandHandler<BlockProduct.Command, BlockProduct.Result> {
    ...
    public Result handle(Command command) {
        ...
        log.info("[BlockProduct] blocked: productId={}, reason={}, traceId={}",
                command.productId(), command.reason(), MDC.get("traceId"));

        return new Result();
    }

    public record Command(String productId, String reason) {}
