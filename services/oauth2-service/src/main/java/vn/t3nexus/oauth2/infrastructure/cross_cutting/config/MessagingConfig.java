...
// Consumer Kafka đầu tiên của oauth2-service (trước giờ chỉ publish) -- xem UserActivatedConsumer.
// Cấu hình DLQ/retry mirror y hệt identity-service/MessagingConfig.java để đồng nhất behavior.
@Configuration
