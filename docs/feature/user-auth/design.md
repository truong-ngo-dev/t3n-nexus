...
| [`spring-security-login-mfa-bff.md`](../../global/3.technical/spring-security-login-mfa-bff.md)    | Framework: login + MFA flow                                                     |
| [`spring-security-logout-bff.md`](../../global/3.technical/spring-security-logout-bff.md) | Framework: logout + remote revocation                                           |
