...
2. **Debezium** đọc PostgreSQL WAL (logical replication), detect rows mới trong `outbox_events`, push lên Kafka
...
**−** Cần Debezium connector riêng cho từng PostgreSQL schema  
